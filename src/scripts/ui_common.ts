...
//     value: function value(predicate: string) {
//       'use strict';
...
//   var device: string; // 저장된 device

//   var domSecFixed: any; //.sec-fixed

//   var domBoxLayer: HTMLElement; //.box-layer

//   var domWrapFixed: HTMLElement;//.wrap-fixed

//   var domHeaderFixed: HTMLElement; //.header-fixed
